...
let TeammatesController = class TeammatesController {
    ...
    addTeammate(teammateDto) {
        return this.teammatesService.addTeammate(teammateDto);
    }
    updateDialogForAllTeammates(projectId, dialogUpdates) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [teammate_dto_1.TeammateDto]),
    __metadata("design:returntype", void 0)
], TeammatesController.prototype, "addTeammate", null);
__decorate([
    common_1.Patch('/project/:projectId/updateDialogForAllTeammates'),
    __param(0, common_1.Param('projectId')),
    __param(1, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], TeammatesController.prototype, "updateDialogForAllTeammates", null);
__decorate([
    common_1.Delete('/project/:projectId/settings/teammates/deleteTeammate'),
    __param(0, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
