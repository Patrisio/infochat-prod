...
InboxModule = __decorate([
    common_1.Module({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([messagesHistory_repository_1.MessagesHistoryRepository, user_repository_1.UserRepository, channel_repository_1.ChannelRepository])
        ],
        providers: [
